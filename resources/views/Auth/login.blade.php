                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-dark my-4">Sign In</h3>
                                    @if (session('status'))
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1" name="username" for="username">Username</label>
                                            <input class="form-control py-4" id="username" type="text"
                                                name="username" placeholder="Enter username address" />
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="passsword">Password</label>
                                            <input class="form-control py-4" id="username" name="password"
